...
# Remote build script for Garry's Mod RTX Remixed (Release x64)
...
SSH_PORT="2222"
WINDOWS_REPO_PATH="C:\Users\cr\proj\garrys-mod-rtx-remixed-perf"
SOLUTION_FILE="RTXFixesBinary.sln"
CONFIGURATION="Release"
PLATFORM="x64"

echo "Starting remote Release|x64 build on Windows VM..."
...
# Using -t flag for pseudo-terminal to get interactive output
...
if [ $SSH_EXIT_CODE -eq 0 ]; then
    ...
    echo "Output DLL: $WINDOWS_REPO_PATH\\x86_64\\$CONFIGURATION\\gmcl_RTXFixesBinary_win64.dll"
else
    echo ""

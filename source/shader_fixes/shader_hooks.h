...
public:
    ...
    Msg("[Shader Fixes] Testing exception handler with deliberate access violation...\n");
    ...
    __except(EXCEPTION_EXECUTE_HANDLER) {
        Msg("[Shader Fixes] SEH caught the test exception as expected\n");
    }
    
    Msg("[Shader Fixes] If you see this, the VEH might not be working properly\n");
}

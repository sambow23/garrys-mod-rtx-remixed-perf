...
hook.Add("PopulateToolMenu", "RemixAPILights", function()
    spawnmenu.AddToolMenuOption("Utilities", "RTX Remix - API Lights", "RTX_Remix_API_Lights", "Map", "", "", function(panel)
        ...
        panel:NumSlider("Point Size", "rtx_api_map_lights_point_size_mult", 0, 10, 2)
        ...
        panel:NumSlider("Spot Size", "rtx_api_map_lights_spot_size_mult", 0, 10, 2)
        ...
        panel:NumSlider("Env Size", "rtx_api_map_lights_env_size_mult", 0, 10, 2)

...
local cv_brightness_scale = CreateClientConVar("rtx_projectedtexture_wrapper_brightness_scale", "100", true, false, "Brightness scaling for projected textures")
local cv_radius_scale = CreateClientConVar("rtx_projectedtexture_wrapper_radius_scale", "0.05", true, false, "Radius scaling for projected textures")
...
concommand.Add("rtx_projectedtexture_reset_offsets", function()
    RunConsoleCommand("rtx_projectedtexture_wrapper_offset_x", "0")

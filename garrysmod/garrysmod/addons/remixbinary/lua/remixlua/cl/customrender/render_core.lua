...
do
    ...
    hook.Add("PopulateToolMenu", "RemixUnifiedMenu", function()
        spawnmenu.AddToolMenuOption("Utilities", "User", "RTX_Remix_Rendering", "RTX Remix Rendering", "", "", function(panel)
            ...
            panel:CheckBox("2D Skybox Swap Left/Right", "rtx_sky2d_swap_lr")
            panel:Help("Global rotation (deg)")
            panel:NumSlider("Yaw (Z)", "rtx_sky2d_rot_yaw", 0, 360, 0)
            panel:NumSlider("Pitch (Y)", "rtx_sky2d_rot_pitch", 0, 360, 0)
            panel:NumSlider("Roll (X)", "rtx_sky2d_rot_roll", 0, 360, 0)

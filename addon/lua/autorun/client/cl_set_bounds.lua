-- disabled due to engine culling patches.
...
--     ["prop_physics"] = 300,
--     ["prop_dynamic"] = 50, -- Even though dynamic props are technically static, they're not baked with the map.
--     ["npc_.*"] = 10,
-- }
...
--         if class == "rtx_lightupdater" then
--             print(string.format("%-30s %4d (no limit)", class, count))
--         else
...
-- concommand.Add("rtx_bounds_list_entities", function()
--     CountSpecialEntities()
-- end)
